    ...
    * ------------------------------------------------------ */
    const ssLightbox = function() {
        ...
        folioLinks.forEach(function(link) {
            ...
            // Check if the href is a valid ID selector (modal dialog) or a valid URL
            if (modalSelector.startsWith('#')) {
                let modalElement = document.querySelector(modalSelector);
                if (modalElement) {
                    let instance = basicLightbox.create(modalElement, {
                        onShow: function(instance) {
                            // Detect Escape key press to close the modal
                    ...
                    console.warn(`Modal element not found for selector: ${modalSelector}`);
                }
            } else {
                console.warn(`Invalid modal selector: ${modalSelector}`);
            }
        });
